...
def execute_trade(
    ...
    """
    global POSITION_SIDE, ENTRY_PRICE, POSITION_SIZE, TOTAL_PNL, WIN_TRADES, TOTAL_TRADES, CUMULATIVE_PNL, RETURN_HISTORY
...
def main():
    global POSITION_SIDE, ENTRY_PRICE, POSITION_SIZE, TOTAL_PNL, WIN_TRADES, TOTAL_TRADES, CUMULATIVE_PNL, RETURN_HISTORY, data_df
